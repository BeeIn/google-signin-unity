...
namespace Google.Impl
{
    ...
    internal class GoogleSignInViaCredentialsX : BaseObject, ISignInImpl
    {

        internal GoogleSignInViaCredentialsX(GoogleSignInConfiguration configuration) : base(GoogleSignIn_Create(GetPlayerActivity()))
        {
